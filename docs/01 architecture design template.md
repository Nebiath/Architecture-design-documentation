# [Nombre del Servicio] - Diseño de Arquitectura

> **Version:** 1.0  
> **Fecha:** YYYY-MM-DD  
> **Estado:** [Draft | Review | Approved | Deprecated]  
> **Autor:** [Nombre del arquitecto/equipo]  
> **Service Owner:** [Nombre y contacto]  
...
[Descripción en 2-3 líneas del propósito de negocio]
...
|----|-----------|-----------|--------|
| RF-001 | [Descripción del requisito funcional] | Must/Should/Could | ✅ Implementado |
| RF-002 | | | |

### 2.2 Requisitos No Funcionales

#### Performance
- **Throughput esperado:** [X requests/segundo en pico]
- **Latencia objetivo:** 
  - p50: [X ms]
  - p95: [X ms]
  - p99: [X ms]
...
```
[Insertar diagrama - puede ser ASCII art, link a draw.io, o imagen]
...
**Contexto:**
[Descripción de cómo el servicio interactúa con usuarios y sistemas externos]
